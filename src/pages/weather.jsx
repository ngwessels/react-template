...
// import "snapsvg-cjs";
import SlowMo, { TweenMax, Power0, Power2, Power4, Power1, Elastic, gsap } from 'gsap';
...
class index extends React.Component {
    ...
    componentDidMount() {
        ...
        function makeRain() {
            ...
            // Draw the line
            const rainHolderNum = (3 - Math.floor(lineWidth));
            let currentRainHolder;
            if (rainHolderNum === 1) currentRainHolder = innerRainHolder1;
            else if (rainHolderNum === 2) currentRainHolder = innerRainHolder2;
            else if (rainHolderNum === 3) currentRainHolder = innerRainHolder3;
            var line = currentRainHolder.path('M0,0 0,' + lineLength).attr({
                fill: 'none',
        ...
        function makeLeaf() {
            ...
            if (scale > 0.8) {
                ...
                xBezier = x + (sizes.container.width - sizes.card.offset.left);
                ...
                x = -100;
                xBezier = sizes.card.width;
                endX = sizes.card.width + 50;

            }
            leafs.push(newLeaf);
            let intensity = 2;
            if (currentWeather.intensity >= 2 && currentWeather.intensity < 5) intensity = 1.5;
            else if (currentWeather.intensity >= 5) intensity = 0.1;
            gsap.fromTo(newLeaf.node, { rotation: Math.random() * 180, x: x, y: y, scale: scale }, { rotation: Math.random() * 360, onComplete: onLeafEnd, onCompleteParams: [newLeaf], ease: Power0.easeIn, x: xBezier, y: (Math.random() * endY) + (endY / 3), duration: Math.random() * intensity + 1 })
        }
                ...
                <div className="background">
                    <div className="container">
                        <svg id="back">
                            ...
                            <path id="sunburst" style={{ fill: 'url(#SVGID_1_)', opacity: 0 }} d="M0,319.7c-18.6,0-37.3-1.6-55.5-4.8L-7.8,41.4c5.1,0.9,10.6,0.9,15.7,0L56,314.8C37.6,318,18.8,319.7,0,319.7z
                        ...
                        <div className="card-container">
                                ...
                                <ul>
                                    <li>
                                        <a data-bind="click: function(data, event){ $parent.changeWeather(data, event)}">
                                            <i className="wi" data-bind="css: icon, attr: {title: name}"></i>
                                        </a>
                                    </li>
                                </ul>
                            </nav>
                            <div id="card" className="weather">
                                <svg id="inner">
                                    ...
                                    <circle id="sun" cx="0" cy="0" r="50" style={{ transform: 'matrix(1, 0, 0, 1, 150, -100)' }} />
                                    <g id="layer3"></g>
                                    <g id="cloud3" className="cloud"></g>
                                    <g id="fog3" className="fog"></g>
                                    <g id="layer2"></g>
                                    <g id="fog2" className="fog"></g>
                                    <g id="cloud2" className="cloud"></g>
                                    <g id="layer1"></g>
                                    <g id="cloud1" className="cloud"></g>
                                    <g id="fog1" className="fog"></g>
                                </svg>
                                <div className="details">
                                    <div className="temp"><span id="temperature">60</span><span className="super" id="format">f</span></div>
                                    <div className="right">
